...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="flex flex-row md:static md:items-center flex-wrap p-2">
        <div
        ...
        <div className="md:visible invisible flex md:max-w-6xl mx-auto">
          <Link href="/">
        ...
        <div className={`${active ? "visible" : "invisible"} nav-overlay`}>
